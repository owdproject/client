    ...
    <div class="win11-shell">
      ...
      <nav class="win11-dock win11-dock--fixed" aria-label="Taskbar">
        ...
        <div class="win11-dock__center-cluster">
          ...
          <button
            type="button"
            class="win11-dock__icon win11-dock__icon--search"
            :class="{ 'win11-dock__icon--active': startMenuOpen }"
            :aria-label="$t('win11.taskbar.search')"
            @click="openSearchLikeStart"
          >
            <img
              class="win11-dock__search-icon"
              :src="searchIconUrl"
              alt=""
            />
          </button>
...
.win11-dock__icon--search:active .win11-dock__search-icon {
  width: 20px;
  height: 20px;
}

.win11-dock__icon:active img:not(.win11-dock__search-icon) {
  width: 20px;
  height: 20px;
}
