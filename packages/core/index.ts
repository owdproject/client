...
export { setDesktopExtensionConfig } from './runtime/utils/setDesktopExtensionConfig'
export { mergeDesktopExtensionConfig } from './runtime/utils/mergeDesktopExtensionConfig'
